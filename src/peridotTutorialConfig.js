...
export const PERIDOT_TUTORIAL_STEPS = Object.freeze([
  ...
  },
  {
    ...
    unavailableText: 'This dataset does not contain usable dates for the Timeline. You can continue without changing anything.',
  ...
  },
  {
    ...
    unavailableText: 'There is no selectable map or network item in the current view. Continue to the next part of the tour.',
  ...
  },
  {
    ...
    unavailableText: 'There are no searchable records in the current dataset. Continue using the current empty result set.',
  ...
  },
  {
    ...
    completeTitle: 'You have completed the Peridot tour',
    ...
    unavailableText: 'There is nothing exportable in the current view. You can still finish the tour or return to another visualization later.',
    closedAnchorSelector: 'button',
