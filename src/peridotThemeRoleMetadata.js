...
export const PERIDOT_THEME_ROLE_GROUPS = Object.freeze([
  ...
  {
    id: 'inspector-roles',
    label: 'Inspector workspace and side panel',
    description: 'Compact and full Inspector shells, dossier cards, nested evidence sections, linked chips, buttons, badges, and empty states.',
    roles: [
      { path: 'inspector.chromeBg', label: 'Inspector chrome', usage: 'Compact Inspector shell and full Inspector frame background.' },
      { path: 'inspector.chromeBgStrong', label: 'Strong Inspector chrome', usage: 'Deepest Inspector shell gradient stop and high-contrast frame areas.' },
      { path: 'inspector.chromeBorder', label: 'Inspector chrome border', usage: 'Outer border for compact and full Inspector frames.' },
      { path: 'inspector.chromeText', label: 'Inspector chrome text', usage: 'Primary text on dark Inspector chrome.' },
      { path: 'inspector.chromeMutedText', label: 'Muted Inspector chrome text', usage: 'Kickers, helper copy, and metadata on dark Inspector chrome.' },
      { path: 'inspector.headerBg', label: 'Inspector header background', usage: 'Header panel behind the Inspector title, information button, and workspace description.' },
      { path: 'inspector.headerBorder', label: 'Inspector header border', usage: 'Header panel outline and inner dividers.' },
      { path: 'inspector.headingText', label: 'Inspector heading text', usage: 'Main Inspector title and prominent headings on Inspector chrome.' },
      { path: 'inspector.bodyBg', label: 'Inspector body background', usage: 'Scrollable body background behind cards and evidence sections.' },
      { path: 'inspector.bodyText', label: 'Inspector body text', usage: 'Primary text in the Inspector body area.' },
      { path: 'inspector.bodyMutedText', label: 'Muted Inspector body text', usage: 'Secondary body text and explanatory copy.' },
      { path: 'inspector.bodyBorder', label: 'Inspector body border', usage: 'Scrollable body panel border and body dividers.' },
      { path: 'inspector.summaryCardBg', label: 'Inspector summary card', usage: 'Top summary/dossier card for the selected item.' },
      { path: 'inspector.summaryCardBorder', label: 'Inspector summary border', usage: 'Summary card border and dividing rules.' },
      { path: 'inspector.summaryCardText', label: 'Inspector summary text', usage: 'Text inside the top summary/dossier card.' },
      { path: 'inspector.cardBg', label: 'Inspector card', usage: 'General Inspector detail cards and nested profile panels.' },
      { path: 'inspector.cardBorder', label: 'Inspector card border', usage: 'General card outlines and section boundaries.' },
      { path: 'inspector.cardText', label: 'Inspector card text', usage: 'Primary text inside Inspector cards.' },
      { path: 'inspector.cardMutedText', label: 'Muted Inspector card text', usage: 'Secondary text inside Inspector cards.' },
      { path: 'inspector.cardHoverBg', label: 'Inspector card hover', usage: 'Hover state for navigable cards and dossier rows.' },
      { path: 'inspector.sectionBg', label: 'Inspector section background', usage: 'Nested people/place/evidence sections inside cards.' },
      { path: 'inspector.sectionBorder', label: 'Inspector section border', usage: 'Nested section outlines and internal dividers.' },
      { path: 'inspector.statCardBg', label: 'Inspector stat card', usage: 'Small statistic and metadata card backgrounds.' },
      { path: 'inspector.buttonBg', label: 'Inspector button', usage: 'Back, Expand, Close, and linked-record action buttons.' },
      { path: 'inspector.buttonHoverBg', label: 'Inspector button hover', usage: 'Hover state for Inspector action buttons.' },
      { path: 'inspector.badgeBg', label: 'Inspector badge', usage: 'Small count/date/status badges inside Inspector records.' },
      { path: 'inspector.badgeText', label: 'Inspector badge text', usage: 'Text inside Inspector badges.' },
      { path: 'inspector.emptyStateBg', label: 'Inspector empty state', usage: 'Empty-state panel background when no evidence item is selected.' },
      { path: 'inspector.emptyStateText', label: 'Inspector empty text', usage: 'Empty-state explanatory text.' },
      { path: 'inspector.detailLabelText', label: 'Inspector detail labels', usage: 'Field labels and uppercase metadata labels inside evidence cards.' },
      { path: 'inspector.clickableBg', label: 'Clickable Inspector chip', usage: 'Linked people, places, routes, and navigable chips.' },
      { path: 'inspector.clickableBorder', label: 'Clickable chip border', usage: 'Border around linked Inspector chips.' },
      { path: 'inspector.clickableText', label: 'Clickable chip text', usage: 'Primary text on linked Inspector chips.' },
      { path: 'inspector.clickableMutedText', label: 'Muted clickable chip text', usage: 'Secondary text on linked Inspector chips.' },
      { path: 'inspector.clickableHoverBg', label: 'Clickable chip hover', usage: 'Hover state for linked Inspector entities.' },
      { path: 'inspector.clickableHoverText', label: 'Clickable hover text', usage: 'Text on hovered linked Inspector chips.' },
      { path: 'inspector.clickableBadgeBg', label: 'Clickable chip badge', usage: 'Small badges inside linked Inspector chips.' },
    ],
  },
  {
    id: 'status-roles',
    label: 'Status and warnings',
    description: 'Warnings, danger states, and error colors shared across workspaces.',
    roles: [
