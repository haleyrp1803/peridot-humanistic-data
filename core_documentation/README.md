...
Peridot is an open, research-oriented web application for exploring humanistic tabular data through maps, networks, timelines, charts, Advanced Search, exports, and evidence dossiers. Its mature first use case is correspondence data, but its role-based import workflow also supports point/site data, chart-first time series, and generic evidence records that do not require person-to-person relationships.
